...
st.title("ProfSight McGill: Course Dashboard")
...
if course_name == "":
    ...
    with col2:
        ...
        grades_by_time_bar = px.line(sorted_summary[sorted_summary["SubjectCode"].isin(courses_bar)], x="TermName", y="MeanGPA", color="SubjectCode",
...
#Statistics by Class
    ...
    std_dev_grade = round(sorted_courseOverTime["ClassAveNum"].std(), 3)
    ...
    with col1:
        ...
        with col12:
            st.metric(label = "Std. Deviation (GPA)", value = std_dev_grade)
